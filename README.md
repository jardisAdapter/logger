...
A powerful PSR-3 compliant logging library for PHP 8.2+. Unlike traditional loggers, Jardis Logger provides a **fluent builder** with 20+ handlers, smart handlers for production (FingersCrossed, Sampling, Conditional), and built-in support for **Domain-Driven Design** with context-based logging per bounded context.
...
- **Immutable Logger** - Builder configures, Logger is immutable after construction
...
// One line. Done.
$logger = (new LoggerBuilder('MyApp'))

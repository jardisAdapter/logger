...
use JardisAdapter\Logger\Contract\LogDataInterface;
...
class LogCommand implements StreamableLogCommandInterface
{
    ...
    private LogDataInterface $logData;
    ...
    public function logData(): LogDataInterface
    {
    ...
    public function setLogData(LogDataInterface $logData): self
    {
